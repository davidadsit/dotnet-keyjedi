...
namespace Jedi
{
    public partial class Form1 : Form
    {
        ...
        private ShortcutMemorizer memos = new ShortcutMemorizer();
        private KeyStateManager mgr = new KeyStateManager();
        private string mouselessModeKey = Settings.Default.MouselessModeKey;
        ...
        public Form1()
        {
            ...
            _mouseHook.MouseEvent += new MouseHook.MouseEventHandler(MouseHookMouseEvent);
            _keyboardHook = new KeyboardHook();
            _keyboardHook.KeyboardEvent += new KeyboardHook.KeyboardEventHandler(KeyboardHookKeyboardEvent);
        ...
        private void SetAppTitle()
        {
            ...
            if (_disabler != null)
            {
                label1.Visible = true;
                Text = @"Mouseless Mode";
                string str = string.Format("Mouseless Mode on [{0}].\n Press Ctrl+Alt+Shift+F12 to regain mouse control.", _disabler.AppTitle);
                label1.Text = str;
            }
        }
        ...
        private void Form1Load(object sender, EventArgs e)
        {
            ...
            Refresh();
            mgr.ShortcutActivated += new KeyStateManager.ShorcutDelegate(mgr_OnShortcutActivated);
        ...
        private void SetMemoOnSelectedItem()
        {
            if (listView1.SelectedItems.Count != 0)
            {
                ...
                string memo = Interaction.InputBox(title, promptText, "Action triggerd by " + item.Text); //, new Point(Location.X, Location.Y));
                TopMost = true;
